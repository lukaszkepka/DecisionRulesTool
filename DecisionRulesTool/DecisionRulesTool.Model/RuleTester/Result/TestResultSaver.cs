...
namespace DecisionRulesTool.Model.RuleTester.Result
{
    public class TestResultSaver
    {
        ...
        {
                TestResultToDataTableConverter TestResultConverter = new TestResultToDataTableConverter();
                var TestResultDataTable = TestResultConverter.ConvertClassificationTable(testRequest);
                var ConfusionMatrix = TestResultConverter.ConvertConfusionMatrix(testRequest);
        ...
        public void SaveResultToFile(string filePath, DataTable ConfusionMatrix, DataTable TestResultDataTable, TestRequest testRequest)
        {
            ...
            {
                _FiltersToStringConverter filtersToStringConverter = new _FiltersToStringConverter();
