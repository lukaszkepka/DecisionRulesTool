...
namespace DecisionRulesTool.Te.RuleTester
{
    ...
    public class RefuseConflictsTests : ITestDataProvider<RuleSet>
    {
        ...
        public void RunClassification_AllExamplesPositive()
        {
            ...
            testSet.Objects.Add(DataProvider.GetObject(testSet, 1.0, 4.0, "T"));
            testSet.Objects.Add(DataProvider.GetObject(testSet, 2.0, 5.0, "T"));
        ...
        {
            DataSet testSet = DataProvider.GetDataset(new[] { AttributeType.Numeric, AttributeType.Numeric, AttributeType.Symbolic }, new[] { "C1", "C2", "D1" }, null);
            testSet.Objects.Add(DataProvider.GetObject(testSet, 1.0, 4.0, "N"));
            testSet.Objects.Add(DataProvider.GetObject(testSet, 2.0, 5.0, "N"));
